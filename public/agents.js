...
(() => {
  const { esc, fmtDur, ago, shortModel, STATUS_VI } = window.LAAM;
  ...
  function cardHtml(s) {
    ...
    return `<div class="card ${s.status}" data-id="${esc(s.id)}">
      <div class="card-top">
  ...
  function renderTimeline(d) {
    const head = `<div class="meta" style="margin-bottom:16px">
