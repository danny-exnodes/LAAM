...
export const chat: Dict = {
  ...
  'chat.setAgentLabel': { vi: 'Trợ lý (persona)', en: 'Assistant (persona)', zh: '助手（persona）' },
  'chat.agentDefault': { vi: 'Trợ lý mặc định', en: 'Default assistant', zh: '默认助手' },
  'chat.setAgentHint': { vi: 'Dùng system prompt của Custom Agent đã lưu.', en: 'Use a saved Custom Agent as the persona.', zh: '使用已保存的 Custom Agent 作为 persona。' },
  ...
  'chat.docxNoText': { vi: 'Tệp .docx không có nội dung văn bản.', en: 'The .docx has no text content.', zh: '该 .docx 没有文本内容。' },
  ...
  'chat.grpCerebras': { vi: 'Cerebras API — tính phí', en: 'Cerebras API — billed', zh: 'Cerebras API — 按用量计费' },
