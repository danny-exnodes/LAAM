...
export const CORE_FEATURES: CoreFeature[] = [
  {
    ...
    tags: ['SSE', 'transcripts'], gauge: { value: 99, label: '99%' }, revealAt: 0.12,
  },
  {
    id: 'chat', num: 2, part: 'core', icon: MessageSquare, keyPrefix: 'feat.2',
    modId: 'MOD-02 // REACTOR CORE', status: 'GPU',
    telemetry: [T('feat.2.t1', 'qwen3-vl'), T('feat.2.t2', '$0'), T('feat.2.t3', 'web·ocr')],
    tags: ['Ollama', 'free'], gauge: { value: 100, label: '$0' }, revealAt: 0.2,
  },
  {
    id: 'connectors', num: 3, part: 'armL', icon: Plug, keyPrefix: 'feat.3',
    modId: 'MOD-03 // MANIPULATOR-L', status: '7 LINKED',
    telemetry: [T('feat.3.t1', '7'), T('feat.3.t2', 'AES-256'), T('feat.3.t3', 'gated')],
    tags: ['OAuth', 'per-user'], gauge: { value: 100, label: '7/7' }, revealAt: 0.4,
  },
  {
    ...
    tags: ['engine', 'scheduler'], gauge: { value: 86, label: 'auto' }, revealAt: 0.55,
  },
  {
    ...
    tags: ['collector', 'zero-dep'], gauge: { value: 100, label: 'sync' }, revealAt: 0.72,
  },
  {
    ...
    tags: ['recharts', 'xyflow'], gauge: { value: 92, label: 'live' }, revealAt: 0.86,
  },
];
