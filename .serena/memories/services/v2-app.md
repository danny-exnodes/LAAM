...
- Tiếp theo: **Wave 4 Connectors** (xây mới: schema connector_credentials mã hoá + framework + 7 connector + tool-loop trong /api/chat). Tham khảo lib/connectors/* của v1.
